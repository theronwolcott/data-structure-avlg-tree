...
public class StudentTests {
    ...
    @Test
    public void testBasics() throws InvalidBalanceException {
        //Integer[] nums = {0, 1, 2, 3, 4, 5, 6, 7};
        //Integer[] nums = {7, 6, 5, 4, 3, 2, 1, 0};
        // Integer[] nums = {3, 2, 1, 0, 7, 6, 5, 4};
         Integer[] nums = {5, 3, 4, 7, 9, 6, 1};
        tree = new AVLGTree<Integer>(1);
        for (int num : nums) {
                tree.insert(num);
                System.out.println(num + ": " + tree.isBST() + "; " + tree.isAVLGBalanced());
        }
    }

    @Test
    public void testDeleteBasics() throws InvalidBalanceException, EmptyTreeException {
        //Integer[] nums = {0, 1, 2, 3, 4, 5, 6, 7};
        //Integer[] nums = {7, 6, 5, 4, 3, 2, 1, 0};
        // Integer[] nums = {3, 2, 1, 0, 7, 6, 5, 4};
         Integer[] nums = {5, 3, 4, 7, 9, 6, 1};
    ...
    @Test
    public void testAdvancedDelete() throws InvalidBalanceException, EmptyTreeException {
        tree = new AVLGTree<Integer>(1);
